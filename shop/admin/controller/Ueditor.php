...
class Ueditor extends Base
{
	...
	public function index(){
        ...
        $CONFIG2 = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", "", file_get_contents("./static/pluginsadmin/plugin/webuploader/config.json")), true);
        $action = $_GET['action'];
