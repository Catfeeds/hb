<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\rechargedetail\index.html";i:1519982731;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                            ...
                                            <div class="form-group right">
                                                ...
                                                <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="type" class="form-control lyui-select select">
                                                        ...
                                                        <option <?php if(input('get.type') == 'online'): ?>selected="true"<?php endif; ?>  value="online">在线充值</option>
                                                        <option <?php if(input('get.type') == 'underline'): ?>selected="true"<?php endif; ?>  value="underline">线下充值</option>
                                                    </select>                                            
                                                </div>
                                                ...
                                                <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="paytype" class="form-control lyui-select select">
                                                        ...
                                                        <option <?php if(input('get.paytype') == '微信支付'): ?>selected="true"<?php endif; ?>  value="微信支付">微信支付</option>
                                                        <option <?php if(input('get.paytype') == '支付宝支付'): ?>selected="true"<?php endif; ?>  value="支付宝支付">支付宝支付</option>
                                                        <option <?php if(input('get.paytype') == '网银支付'): ?>selected="true"<?php endif; ?>  value="网银支付">网银支付</option>
                                                    </select>                                            
                                                </div>
                                    ...
                                    <div class="builder-table">
                                        <div class="panel panel-default table-responsive">
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr><th colspan="20" >金额合计：<span style="color: red" ><?php echo $total; ?></span></th></tr>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>类型</th>
                                                    <th>充值金额</th>
                                                ...
                                                <tbody>
                                                <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))):  $this_total=0;  if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if($data['status'] == '0'): ?>未完成<?php endif; if($data['status'] == '1'): ?>完成<?php endif; ?>
                                                            </td>
                                                            
                                                        </tr>

                                                        <?php  $this_total=$this_total+$data['money'];  endforeach; endif; else: echo "" ;endif; ?>
                                                    <tr>
                                                        <td style="background: #c7e7ff;" >本页合计</td>
                                                        <td style="border:none" ></td>
                                                        <td style="border:none; color:red;" ><?php echo $this_total; ?></td>
                                                        <td style="border:none" ></td>
                                                        <td style="border:none" ></td>
                                                        <td style="border:none" ></td>
                                                    </tr>
    ...
    <script type="text/javascript">
        ...
        function setStatus(type){
           ...
           $.ajax({
                ...
                url:"<?php echo url('setDataStatus'); ?>",
