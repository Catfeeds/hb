<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\login\login.html";i:1514211959;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
...
<body class="admin_config_group" >
    ...
    <div class="panel-lite">
        ...
        <h4>后台管理登录</h4>
        <form class="login-form" action="<?php echo url('login/dologin'); ?>" method="post">
