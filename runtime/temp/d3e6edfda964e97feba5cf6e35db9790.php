<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/adminmall\view\good\edit.html";i:1517018892;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                        ...
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input" name="good_name" value="<?php echo (isset($info['good_name']) && ($info['good_name'] !== '')?$info['good_name']:''); ?>" placeholder="商品名称" >
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">商品编号：</label>
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input text" name="good_no" placeholder="编号" value="<?php echo (isset($info['good_no']) && ($info['good_no'] !== '')?$info['good_no']:''); ?>" >
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input" name="good_supplier" value="<?php echo (isset($info['good_supplier']) && ($info['good_supplier'] !== '')?$info['good_supplier']:''); ?>" placeholder="供应商" >
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">售价：</label>
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input text" name="good_price" value="<?php echo (isset($info['good_price']) && ($info['good_price'] !== '')?$info['good_price']:''); ?>" placeholder="销售价格" >
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input" name="market_price" value="<?php echo (isset($info['market_price']) && ($info['market_price'] !== '')?$info['market_price']:''); ?>" placeholder="市场价" >
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">成本价：</label>
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input" name="cost_price" value="<?php echo (isset($info['cost_price']) && ($info['cost_price'] !== '')?$info['cost_price']:''); ?>" placeholder="成本价" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group item_title">
                                                ...
                                                <div style="width:42%" class="input-group">
                                                    <input type="text" name="good_commission" class="form-control text" value="<?php echo (isset($info['good_commission']) && ($info['good_commission'] !== '')?$info['good_commission']:''); ?>" placeholder="佣金比例">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div style="width:42%" class="input-group">
                                                    <input type="text" name="good_weight" class="form-control"  placeholder="商品重量" value="<?php echo (isset($info['good_weight']) && ($info['good_weight'] !== '')?$info['good_weight']:''); ?>" >
                                                ...
                                                <div class="right">
                                                    <div class="radio-inline lyui-control lyui-radio">
                                                        <label for="typemodule">
                                                            <input type="radio" <?php if($info['ship_fee'] == '1'): ?>checked="true"<?php endif; ?> id="typemodule" class="radio" name="ship_fee" value="module"> 
                                                    ...
                                                    <div class="radio-inline lyui-control lyui-radio">
                                                        <label for="typetheme">
                                                            <input type="radio" <?php if($info['ship_fee'] == '0'): ?>checked="true"<?php endif; ?> id="typetheme" class="radio" name="ship_fee" value="theme"> 
                                                            <span class="lyui-control-indicator"></span>
                                                            <span>否</span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="form-group item_title">
                                                ...
                                                <div style="width:60%" class="right">
                                                    <input type="text" name="good_store" class="form-control text input" placeholder="商品库存" value="<?php echo (isset($info['good_store']) && ($info['good_store'] !== '')?$info['good_store']:''); ?>" >
                                                ...
                                                <div class="right">
                                                    <div class="checkbox-inline lyui-control lyui-checkbox">
                                                        <label class="checkbox-label">
                                                            <input <?php if($info['is_hot'] == '1'): ?>checked="true"<?php endif; ?>  type="checkbox" name="is_hot" value="1">
                                                            <span class="lyui-control-indicator"></span>
                                                            <span>热销商品</span>
                                                        </label>
                                                    </div>
                                                    <div class="checkbox-inline lyui-control lyui-checkbox">
                                                        <label class="checkbox-label">
                                                            <input <?php if($info['is_recommend'] == '1'): ?>checked="true"<?php endif; ?> type="checkbox" name="is_recommend" value="1">
                                                            <span class="lyui-control-indicator"></span>
                                                            <span>精品推荐</span>
                                                        </label>
                                                    </div> 
                                                    <div class="checkbox-inline lyui-control lyui-checkbox">
                                                        <label class="checkbox-label">
                                                            <input <?php if($info['is_new'] == '1'): ?>checked="true"<?php endif; ?> type="checkbox" name="is_new" value="1">
                                                            <span class="lyui-control-indicator"></span>
                                                            <span>新品上市</span>
                                                        </label>
                                                    </div>        
                                            ...
                                            <div class="form-group item_title">
                                                ...
                                                <div style="width:60%" class="right">
                                                    <input type="text" name="good_integral" class="form-control input text" placeholder="赠送积分" value="<?php echo (isset($info['good_integral']) && ($info['good_integral'] !== '')?$info['good_integral']:''); ?>" >
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div style="width:60%" class="right">
                                                    <input type="text" class="form-control input text" name="good_sort" placeholder="排序" value="<?php echo (isset($info['good_sort']) && ($info['good_sort'] !== '')?$info['good_sort']:''); ?>" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="right">
                                                    <textarea style="min-height:400px" class="form-control" rows="5" name="good_content"><?php echo (isset($info['good_content']) && ($info['good_content'] !== '')?$info['good_content']:''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-type-list">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div style="width:60%" class="right">
                                                <input type="hidden" id="imagetext" name="good_cover_img" value="<?php echo (isset($info['good_cover_img']) && ($info['good_cover_img'] !== '')?$info['good_cover_img']:''); ?>" class="type-file-text">
                                                <div style="width:20%;height:100px;border:1px solid #ccc;text-align:center" >
                                                    <img style="max-width:100%;max-height:100%;display: block;" id="cover_img" src="<?php echo (isset($info['good_cover_img']) && ($info['good_cover_img'] !== '')?$info['good_cover_img']:''); ?>" alt="">
                                                </div>
                                            ...
                                            <div style="width:60%" class="right">
                                               <div class="tab-pane" id="tab_goods_images">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <?php if(!(empty($good_img) || (($good_img instanceof \think\Collection || $good_img instanceof \think\Paginator ) && $good_img->isEmpty()))): if(is_array($good_img) || $good_img instanceof \think\Collection || $good_img instanceof \think\Paginator): if( count($good_img)==0 ) : echo "" ;else: foreach($good_img as $key=>$v): ?>
                                                                <div class="goods_xc" style="width:100px; text-align:center; margin: 5px; display:inline-block;">
                                                                    <input type="hidden" name="good_image[]" value="<?php echo $v['img_url']; ?>">
                                                                    <a href="<?php echo $v['img_url']; ?>" onclick="" target="_blank"><img src="<?php echo $v['img_url']; ?>" width="100" height="100"></a>
                                                                    <br>
                                                                    <a href="javascript:void(0)" data="<?php echo $v['id']; ?>" onclick="ClearPicArr2(this,'<?php echo $v['img_url']; ?>')">删除</a>
                                                                </div>
                                                                <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                                                <div class="goods_xc" style="width:100px; text-align:center; margin: 5px; display:inline-block;">
                                                                    <input type="hidden" name="good_image[]" value="">
                                                                    <a href="javascript:void(0);" onclick="GetUploadify('<?php echo url('admin/Uploadify/upload',array('num'=>6,'func'=>'call_back2')); ?>')">
       ...
       /** 以下 商品规格相关 js*/
        ...
        function add_good_img(path){
            ...
            if(good_id){
                $.ajax({
                    type:'POST',
                    url:"<?php echo url('Good/addgoodimg'); ?>",
        ...
        function ClearPicArr2(obj,path)
        {
            ...
            $.ajax({
                        type:'GET',
                        url:"<?php echo url('Good/delgoodimg'); ?>",
