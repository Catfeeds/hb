<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/adminmall\view\goodbrand\index.html";i:1515489235;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                                    ...
                                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($data['status'] == '1'): ?>
                                                                <a name="forbid" title="禁用" class="label label-warning-outline label-pill ajax-get confirm" href="<?php echo url('setStatus',array('status'=>'forbid','ids'=>$data['id'])); ?>">禁用</a>
                                                                <?php else: ?>
                                                                <a name="forbid" title="启用" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo url('setStatus',array('status'=>'resume','ids'=>$data['id'])); ?>">启用</a>
                                                                <?php endif; ?>

                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="good_brand" href="<?php echo url('setStatus',array('status'=>'delete','ids'=>$data['id'])); ?>">删除</a>
                                                        </tr>
