<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\message\index.html";i:1517040431;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                ...
                                <!-- 工具栏按钮 -->
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            <a title="发布" class="btn btn-primary-outline btn-pill" href="<?php echo url('add'); ?>">发布</a>&nbsp;
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if(!(empty($data['uid']) || (($data['uid'] instanceof \think\Collection || $data['uid'] instanceof \think\Paginator ) && $data['uid']->isEmpty()))): ?>
                                                                <?php echo get_parent($data['uid'],'mobile'); else: ?>
                                                                全体会员
                                                                <?php endif; ?>
                                                            </td>
                                                            ...
                                                            <td><?php echo $typelist[$data['type']]; ?></td>
