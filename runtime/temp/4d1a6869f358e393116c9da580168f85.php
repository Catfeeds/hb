<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\recharge\index.html";i:1521715127;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="builder-tabs builder-form-tabs">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li <?php if($type == '1'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index',array('type'=>'1')); ?>">已通过</a>
                            </li>
                            <li <?php if($type == '2'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index',array('type'=>'2')); ?>">已拒绝</a>
                            </li>
                        </ul>
                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <?php echo $data['bank_name']; ?>(<?php echo $data['card_no']; ?>)</td>
                                                            <td><a target="_bank" href="<?php echo $data['img']; ?>"> <img style="max-width: 100px;max-height:100px " src="<?php echo $data['img']; ?>"></a></td>
