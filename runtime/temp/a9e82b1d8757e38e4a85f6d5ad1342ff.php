<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\config\turntable.html";i:1521110010;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row" >
                            <div class="col-xs-12" >
                                <div class="form-group">
                                    <label class="left control-label">转盘概率配置</label>
                                </div>

                                <form action="<?php echo url('Config/savezhuanpan'); ?>" method="post" class="form-horizontal form form-builder">
                                <div class="form-type-list">

                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">1000宏宝：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="text" name="one" class="form-control" value="<?php echo $info['one']; ?>" >
                                            
                                        </div>
                                    </div>

                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">500积分：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="text" name="two" class="form-control" value="<?php echo $info['two']; ?>" >
                                            
                                        </div>
                                    </div>

                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">谢谢参与：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="text" name="three" class="form-control" value="<?php echo $info['three']; ?>" >
                                            
                                        </div>
                                    </div>

                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">200积分：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="text" name="four" class="form-control" value="<?php echo $info['four']; ?>" >
