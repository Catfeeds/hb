<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\news\entry.html";i:1514211960;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
...
<body class="admin_config_group" >
    ...
    <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <div class="row">
            ...
            <a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo url('addnews'); ?>">新增</a>&nbsp;
            </div>
            </div>
            ...
            <input type="text" name="keyword" class="search-input form-control" value="<?php echo input('get.keyword'); ?>" placeholder="请输入id/排序/关键字">
        ...
        <div class="panel panel-default table-responsive">
            ...
            <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a name="addnews" title="编辑" class="label label-primary-outline label-pill" href="<?php echo url('addnews',array('ids'=>$data['id'])); ?>">编辑</a>
                        <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Admin" href="<?php echo url('deletenews',array('ids'=>$data['id'])); ?>">删除</a>
                    </td>
                </tr>
