<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/adminmall\view\comment\sellercomment.html";i:1516961179;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                                ...
                                                <tbody>
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <?php 
                                                                echo db('shop_info')->where('uid',$data['seller_id'])->value('shop_name');
                                                             ?>
                                                            </td>
                                                            <td><p style="width: 208px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin: 0;padding: 0;" ><?php echo $data['content']; ?></p></td>
                                                            <td><?php echo $data['good_name']; ?><br /><?php echo $data['good_item']; ?></td>
                                                            <td>
                                                                服务能力：<span style="color:red" ><?php echo $data['star_ability']; ?>星</span><br />
                                                                服务态度：<span style="color:red" ><?php echo $data['star_attitude']; ?>星</span><br />
                                                                价格合理：<span style="color:red" ><?php echo $data['star_price']; ?>星</span>
                                                            </td>
                                                            <td>
                                                                <?php echo $data['username']; ?>(<?php echo $data['mobile']; ?>)
                                                            </td>
