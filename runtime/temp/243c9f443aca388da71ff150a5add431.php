<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\shopstatus\index.html";i:1514942671;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="builder-tabs builder-form-tabs">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li <?php if($type == '2'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index',array('type'=>'2')); ?>">已通过</a>
                            </li>
                            <li <?php if($type == '3'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index',array('type'=>'3')); ?>">已拒绝</a>
                            </li>
                        </ul>
                    </div>
                                            ...
                                            <div class="form-group right">
                                                <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="user_type" class="form-control lyui-select select">
                                                        ...
                                                        <option <?php if(input('get.user_type') == '0'): ?>selected="true"<?php endif; ?>  value="0">个人用户</option>
                                                        <option <?php if(input('get.user_type') == '1'): ?>selected="true"<?php endif; ?>  value="1">企业用户</option>
                                                    </select>                                            
                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $data['user_type']==1?'企业用户':'个人用户'; ?></td>
                                                            <td><?php echo $data['username']; ?>(<?php echo $data['mobile']; ?>)</td>
                                                            <td><?php echo $data['province']; ?>、<?php echo $data['city']; ?>、<?php echo $data['district']; ?></td>
                                                            <td><?php echo date('Y-m-d H:i',$data['create_time']); ?></td>
                                                            <td>
                                                              <?php if($data['user_type'] == 1): if($data['is_check_company'] == '1'): ?>待审核<?php endif; if($data['is_check_company'] == '2'): ?>已通过<?php endif; if($data['is_check_company'] == '3'): ?>已拒绝<?php endif; else: if($data['is_check_user'] == '1'): ?>待审核<?php endif; if($data['is_check_user'] == '2'): ?>已通过<?php endif; if($data['is_check_user'] == '3'): ?>已拒绝<?php endif; endif; ?>
                                                            </td>
                                                           
                                                            <td>
                                                                <a name="edit" title="查看详情" class="label label-primary-outline label-pill" href="<?php echo url('detail',array('uid'=>$data['uid'])); ?>">详情</a>
                                                            </td>
