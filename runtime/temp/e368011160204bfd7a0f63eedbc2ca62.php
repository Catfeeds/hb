<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\news\student.html";i:1513909958;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
...
<body class="admin_config_group" >
	...
	<a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo url('school_add_people'); ?>">新增</a>&nbsp;
	</div>
	</div>
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $data['graded']; ?></td>
				<td><?php echo $data['sort']; ?></td>
				<td>
				<a name="school_add_people" title="编辑" class="label label-primary-outline label-pill" href="<?php echo url('school_add_people',array('id'=>$data['id'])); ?>">编辑</a>
				<a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="good_brand" href="<?php echo url('delete_people',array('id'=>$data['id'])); ?>">删除</a>
				</td>
			</tr>
