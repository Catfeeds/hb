<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/adminmall\view\seller\sellerlist.html";i:1521110009;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                                ...
                                                <tbody>
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo date('Y-m-d H:i',$data['reg_date']); ?></td>
                                                            <td>
                                                                <?php echo get_parent($data['pid'],'account'); ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($data['status'] == '1'): ?>
                                                                <a name="forbid" title="锁定" class="label label-warning-outline label-pill ajax-get confirm" href="<?php echo url('admin/User/setStatus',array('status'=>'forbid','ids'=>$data['userid'])); ?>">锁定</a>
                                                                <?php else: ?>
                                                                <a name="forbid" title="解锁" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo url('admin/User/setStatus',array('status'=>'resume','ids'=>$data['userid'])); ?>">解锁</a>
                                                                <?php endif; ?>
