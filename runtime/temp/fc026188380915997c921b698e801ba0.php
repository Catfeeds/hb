<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\news\zuopin.html";i:1513909963;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8 button-list clearfix">
			<div class="form-group">
				<a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo url('school_add_details'); ?>">新增</a>&nbsp;
			</div>
		</div>
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
			<tr>
				...
				<td><p  ><?php echo $data['title']; ?></p></td>
				<td><?php echo $data['sort']; ?></td>
				<td><?php echo $data['people_name']; ?></td>
				...
				<td>
					<a name="addnews" title="编辑" class="label label-primary-outline label-pill" href="<?php echo url('school_add_details',array('ids'=>$data['id'])); ?>">编辑</a>
					<a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Admin" href="<?php echo url('delete_details',array('ids'=>$data['id'])); ?>">删除</a>
				</td>
			</tr>
