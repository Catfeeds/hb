<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\money\index.html";i:1521186718;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    <div class="builder-tabs builder-form-tabs">
                        <?php $status=input('status/d',0); ?>
                        <ul class="nav nav-tabs">
                            <li <?php if($status == '0'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index'); ?>">待审核</a>
                            </li>
                            <li <?php if($status == '1'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index',array('status'=>'1')); ?>">已通过</a>
                            </li>
                            <li <?php if($status == '2'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('index',array('status'=>'2')); ?>">已拒绝</a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <form class="form" method="get" action="">
                                            <div class="form-group right">
                                                ...
                                                <!-- <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="feetime" class="form-control lyui-select select">
                                                        <option value="">到账时间：</option>
                                                        <option <?php if(input('get.feetime') == '0'): ?>selected="true"<?php endif; ?>  value="0">T+0个工作日到账</option>
                                                        <option <?php if(input('get.feetime') == '1'): ?>selected="true"<?php endif; ?>  value="1">T+1个工作日到账</option>
                                                        <option <?php if(input('get.feetime') == '3'): ?>selected="true"<?php endif; ?>  value="3">T+3个工作日到账</option>
                                                        <option <?php if(input('get.feetime') == '7'): ?>selected="true"<?php endif; ?>  value="7">T+7个工作日到账</option>
                                                    </select>                                            
                                                </div> -->
                                                ...
                                                <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="type" class="form-control lyui-select select">
                                                        ...
                                                        <option <?php if(input('get.type') == '1'): ?>selected="true"<?php endif; ?>  value="1">现金提现</option>
                                                        <option <?php if(input('get.type') == '2'): ?>selected="true"<?php endif; ?>  value="2">宏宝提现</option>
                                                    </select>                                            
                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <?php 
                                                                if($data['type']==1)
                                                                    echo '￥'.($data['money']-$data['fee']);
                                                                else
                                                                    echo '￥'.(($data['money']-$data['fee'])/100);
                                                             ?>
                                                            </td>
                                                            <td><?php echo $data['money']+0; ?></td>
                                                            <td><?php echo $data['fee']+0; ?></td>
                                                            <!-- <td style="color:red" >
                                                                T+<?php echo $data['fee_time']; ?> 个工作日到账
                                                            </td> -->
                                                            <td><?php echo $data['username']; ?><br><?php echo $data['mobile']; ?></td>
                                                            <td>
                                                            <?php echo $data['user_name']; ?>
                                                            <br>
                                                            <?php echo $data['bank_name']; if(!(empty($data['bank_branch']) || (($data['bank_branch'] instanceof \think\Collection || $data['bank_branch'] instanceof \think\Paginator ) && $data['bank_branch']->isEmpty()))): ?>（<?php echo $data['bank_branch']; ?>）<?php endif; ?>
                                                            <br>
                                                            <?php echo $data['card_no']; ?>
                                                        </td>
                                                            ...
                                                            <?php if($data['status'] == '0'): ?>
                                                                <a data="<?php echo $data['id']; ?>"  title="审核" class="shenghe label label-primary-outline label-pill" href="javascript:">审核</a>
                                                            <?php else: if(!(empty($data['reply']) || (($data['reply'] instanceof \think\Collection || $data['reply'] instanceof \think\Paginator ) && $data['reply']->isEmpty()))): ?>
                                                                回复：<?php echo $data['reply']; endif; endif; ?>
                                                            </td>
    ...
    <script type="text/javascript">
        ...
        function setStatus(type){
           ...
           $.ajax({
                ...
                url:"<?php echo url('Money/setDataStatus'); ?>",
