<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\article\index.html";i:1516356862;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                ...
                                <!-- 工具栏按钮 -->
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            <a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo url('addarticle'); ?>">新增</a>&nbsp;
                                        </div>
                                    </div>
                                    ...
                                    <form class="form" method="get" action="">
                                        <div class="form-group">
                                            <div class="input-group search-form">
                                                <input type="text" name="keyword" class="search-input form-control" value="<?php echo input('get.keyword'); ?>" placeholder="请输入id/关键字">
                                        ...
                                        <div class="panel panel-default table-responsive">
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $type_name=array(0=>'',1=>'关于我们',2=>'用户注册协议',3=>'新手上路');
                                                  ...
                                                  <!--           <td>
                                                      <input class="ids" type="checkbox" value="<?php echo $data['id']; ?>" name="ids[]">
                                                            ...
                                                            <td><p style="width: 208px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin: 0;padding: 0;" ><?php echo $data['title']; ?></p></td>
                                                            
                                                            <td><?php echo $type_name[$data['type']]; ?></td>
                                                
                                                            <td><?php echo date("Y-m-d H:i",$data['savetime']); ?></td>
                                                          
                                                            <td>
                                                                 <a name="addnews" title="编辑" class="label label-primary-outline label-pill" href="<?php echo url('addarticle',array('ids'=>$data['id'])); ?>">编辑</a>
                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Admin" href="<?php echo url('deleterticle',array('ids'=>$data['id'])); ?>">删除</a>
                                                                </td>
