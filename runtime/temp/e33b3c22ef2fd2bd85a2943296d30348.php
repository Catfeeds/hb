<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/adminmall\view\order\index.html";i:1517549809;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                            ...
                                            <div class="form-group right">
                                                <!-- <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="order_status" class="form-control lyui-select select">
                                                        ...
                                                        <option <?php if(input('get.order_status') == '0'): ?>selected="true"<?php endif; ?>  value="0">未支付</option>
                                                        <option <?php if(input('get.order_status') == '1'): ?>selected="true"<?php endif; ?>  value="1">已支付</option>
                                                        <option <?php if(input('get.order_status') == '2'): ?>selected="true"<?php endif; ?>  value="2">已发货</option>
                                                        <option <?php if(input('get.order_status') == '3'): ?>selected="true"<?php endif; ?>  value="2">已完成</option>
                                                    </select>
                                                </div> -->
                                                ...
                                                <div style="float:left;width:120px;margin-right:20px" class="">
                                                    <select name="querytype" class="form-control lyui-select select">
                                                        ...
                                                        <option <?php if(input('get.querytype') == 'user_name'): ?>selected="true"<?php endif; ?> value="user_name">收货姓名</option>
                                                         <option <?php if(input('get.querytype') == 'user_mobile'): ?>selected="true"<?php endif; ?>  value="user_mobile">收货手机</option>
                                                        <option <?php if(input('get.querytype') == 'username'): ?>selected="true"<?php endif; ?>  value="username">会员姓名</option>
                                                        <option <?php if(input('get.querytype') == 'mobile'): ?>selected="true"<?php endif; ?>  value="mobile">会员手机</option>
                                                    </select>                                            
                                                </div>
                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php 
                                                     ...
                                                     if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            <td><?php echo $data['order_no']; ?></td>
                                                            <td><?php echo $data['user_name']; ?>:<?php echo $data['user_mobile']; ?></td>
                                                            <td><?php echo $data['order_total_price']; ?></td>
                                                            <td><?php echo date("Y-m-d H:i",$data['order_create_time']); ?></td>
                                                             <td><?php echo $status_name[$data['order_status']]; ?></td>
                                                          
                                                            <td>
                                                                <a name="addnews" title="编辑" class="label label-primary-outline label-pill" href="<?php echo url('detail',array('order_id'=>$data['order_id'])); ?>">编辑</a>
                                                                <?php if($data['order_status'] == '0'): ?>
                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Admin" href="<?php echo url('delete',array('order_id'=>$data['order_id'])); ?>">删除</a>
                                                                <?php endif; ?>
                                                                </td>
