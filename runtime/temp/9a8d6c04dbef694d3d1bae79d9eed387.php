<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\banner\edit.html";i:1514211957;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal form form-builder" enctype="multipart/form-data" >
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="right">
                                                    <select name="b_type" class="form-control cui-select select">
                                                        <?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): ?>
                                                        <option value="">请选择：</option>
                                                        <?php endif; if(is_array($psdata) || $psdata instanceof \think\Collection || $psdata instanceof \think\Paginator): if( count($psdata)==0 ) : echo "" ;else: foreach($psdata as $k=>$v): ?>
                                                        <option <?php if(isset($info['b_type']) AND ($info['b_type'] == $k)): ?>selected="true"<?php endif; ?> value="<?php echo $k; ?>"><?php echo $v; ?></option>
                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input  type="text" class="form-control input" name="b_name" value="<?php echo (isset($info['b_name']) && ($info['b_name'] !== '')?$info['b_name']:''); ?>" placeholder="名称" >
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">广告图片：</label>
                                                <div class="right">
                                                    <?php if(!(empty($info['b_img']) || (($info['b_img'] instanceof \think\Collection || $info['b_img'] instanceof \think\Paginator ) && $info['b_img']->isEmpty()))): ?>
                                                        <img  style="max-width:300px;max-height:300px;" src="<?php echo $info['b_img']; ?>" alt="">
                                                    <?php endif; ?>
                                                    <input style="border:none;box-shadow:none" type="file" class="form-control input" name="b_img"  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="b_link" placeholder="广告链接" value="<?php echo (isset($info['b_link']) && ($info['b_link'] !== '')?$info['b_link']:''); ?>" >
                                                </div>
                                            </div>
                                             <div class="form-group item_title ">
                                                <label class="left control-label">广告排序：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="b_order" value="<?php echo (isset($info['b_order']) && ($info['b_order'] !== '')?$info['b_order']:'0'); ?>" placeholder="默认排序">
                                                </div>
                                            </div>
