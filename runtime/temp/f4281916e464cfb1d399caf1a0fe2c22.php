<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\banner\index.html";i:1514211957;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                        ...
                                        <div class="form-group">
                                            <div style="float:left;margin-right:20px" class="">
                                                <select name="status" class="form-control lyui-select select">
                                                    ...
                                                    <?php if(is_array($psdata) || $psdata instanceof \think\Collection || $psdata instanceof \think\Paginator): if( count($psdata)==0 ) : echo "" ;else: foreach($psdata as $k=>$v): ?>
                                                        <option <?php if(input('get.status') == $k): ?>selected="true"<?php endif; ?> value="<?php echo $k; ?>"><?php echo $v; ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>                                            
                                            </div>
                                            <div class="input-group search-form">
                                                <input type="text" name="keyword" class="search-input form-control" value="<?php echo input('get.keyword'); ?>" placeholder="名称">
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $psdata[$data['b_type']]; ?></td>
                                                            <td><?php echo $data['b_name']; ?></td>
                                                            <td>
                                                            <?php if(!(empty($data['b_img']) || (($data['b_img'] instanceof \think\Collection || $data['b_img'] instanceof \think\Paginator ) && $data['b_img']->isEmpty()))): ?>
                                                            <a href="<?php echo $data['b_img']; ?>">
                                                            <img style="max-width:100px;max-height:100px;" src="<?php echo $data['b_img']; ?>">
                                                            </a>
                                                            <?php endif; ?>
                                                            </td>
                                                            <!-- <td><?php echo $data['b_link']; ?></td> -->
                                                            <td><?php echo $data['b_order']; ?></td>
                                                            <td>
                                                               <?php if($data['status'] == '1'): ?>
                                                                <a name="forbid" title="显示" class="label label-warning-outline label-pill ajax-get confirm" href="<?php echo url('bannerStutas',array('status'=>'0','ids'=>$data['id'])); ?>">显示</a>
                                                                <?php else: ?>
                                                                <a name="forbid" title="隐藏" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo url('bannerStutas',array('status'=>'1','ids'=>$data['id'])); ?>">隐藏</a>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
                                                                 <a name="edit" title="编辑" class="label label-primary-outline label-pill" href="<?php echo url('edit',array('id'=>$data['id'])); ?>">编辑</a>
                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Admin" href="<?php echo url('bannerStutas',array('status'=>'delete','ids'=>$data['id'])); ?>">删除</a>
                                                        </tr>
