<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\user\edit.html";i:1520233716;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="<?php echo url('User/edit'); ?>" method="post" class="form-horizontal form form-builder">
                                                ...
                                                <div class="form-group item_title">
                                                    ...
                                                    <div style="width:60%" class="right">
                                                        <table class="table table-bordered">
                                                            <tbody>
                                                                <tr>
                                                                    <td><span style="color:#999">类型：</span><?php echo $check_info['user_type']==1?'企业用户':'个人用户'; ?></td>
                                                                    <td><span style="color:#999">是否三证合一：</span><?php echo $check_info['is_three_card']==1?'是':'否'; ?></td>
                                                                    <td><span style="color:#999">是否分公司：</span><?php echo $check_info['is_child_company']==1?'是':'否'; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><span style="color:#999">税务登记证：</span><?php echo $check_info['tax_no']; ?></td>
                                                                    <td><span style="color:#999">社会信用代码：</span><?php echo $check_info['credit_no']; ?></td>
                                                                    <td><span style="color:#999">组织机构证：</span><?php echo $check_info['organize_no']; ?></td>
                                                                </tr>
                                                                 <tr>
                                                                    <td><span style="color:#999">法人：</span><?php echo $check_info['legal_name']; ?></td>
                                                                    <td><span style="color:#999">公司类型：</span><?php echo $check_info['company_type']; ?></td>
                                                                    <td><span style="color:#999">经营负责人：</span><?php echo $check_info['manage_parent']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    <a href="<?php echo $check_info['idcard_img_face']; ?>">
                                                                       <img style="width:50%" src="<?php echo $check_info['idcard_img_face']; ?>" alt=""> 
                                                                       <p style="text-align:center" >正面照</p>
                                                                    </a>
                                                                    </td>
                                                                    <td>
                                                                    <a href="<?php echo $check_info['idcard_img_back']; ?>">
                                                                        <img style="width:50%" src="<?php echo $check_info['idcard_img_back']; ?>" alt="">
                                                                        <p style="text-align:center" >反面照</p>
                                                                    </a>
                                                                    </td>
                                                                    <td>
                                                                    <a href="<?php echo $check_info['idcard_img_hand']; ?>">
                                                                        <img style="width:50%" src="<?php echo $check_info['idcard_img_hand']; ?>" alt="">
                                                                        <p style="text-align:center" >手持照</p>
                                                                    </a>
                                                                    </td>
                                                                </tr>
                                                                <?php if(!(empty($check_info['company_license_img']) || (($check_info['company_license_img'] instanceof \think\Collection || $check_info['company_license_img'] instanceof \think\Paginator ) && $check_info['company_license_img']->isEmpty()))): ?>
                                                                <tr>
                                                                    <td colspan="3" >
                                                                     <a href="<?php echo $check_info['company_license_img']; ?>">
                                                                        <img style="width:33%" src="<?php echo $check_info['company_license_img']; ?>" alt="">
                                                ...
                                                <div class="form-group item_title">
                                                    ...
                                                    <div style="width:60%" class="right">
                                                        <table class="table table-bordered">
                                                            <tbody>
                                                                <tr>
                                                                    <td><span style="color:#999">证件类型：</span><?php echo $check_info['idcard_type']==1?'非大陆身份证':'大陆身份证'; ?></td>
                                                                    <td><span style="color:#999">身份证号：</span><?php echo $check_info['idcard']; ?></td>
                                                                    <td><span style="color:#999">证件有效期：</span><?php echo $check_info['idcar_startdate']; ?> 至 <?php echo $check_info['idcar_endtdate']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    <a href="<?php echo $check_info['idcard_img_face']; ?>">
