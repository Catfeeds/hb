<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\sellerapply\apply.html";i:1516605609;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="builder-tabs builder-form-tabs">
                        ...
                        <ul class="nav nav-tabs">
                            <li <?php if($type == '0'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('apply'); ?>">待审核</a>
                            </li>
                            <li <?php if($type == '1'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('apply',array('type'=>'1')); ?>">已通过</a>
                            </li>
                            <li <?php if($type == '2'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('apply',array('type'=>'2')); ?>">已拒绝</a>
                            </li>
                        </ul>
                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $data['respon_name']; ?></td>
                                                            <td><?php echo $data['con_name']; ?><br /><?php echo $data['con_mobile']; ?><br /><?php echo $data['con_email']; ?></td>
                                                            ...
                                                            <td>
                                                                <a name="edit" title="查看详情" class="label label-primary-outline label-pill" href="<?php echo url('detail',array('id'=>$data['id'])); ?>">详情</a>
                                                            </td>
