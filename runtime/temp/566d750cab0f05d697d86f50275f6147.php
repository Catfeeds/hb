<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\tree\index.html";i:1519714025;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\Public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                    ...
                                    <form class="form" method="get" action="">
                                        <div class="form-group">
                                            <div class="input-group search-form">
                                                <input type="text" name="keyword" class="search-input form-control" value="<?php echo input('keyword'); ?>" placeholder="请输入ID/手机／账号">
