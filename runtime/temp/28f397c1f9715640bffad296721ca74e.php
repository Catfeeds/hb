<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\uploadify\upload.html";i:1515470557;}*/ ?>
<html lang="zh-cn">
<head>
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
<title>文件管理</title>
<link rel="stylesheet" type="text/css" href="__STATIC__/plugin/webuploader/webuploader.css">
<link rel="stylesheet" type="text/css" href="__STATIC__/plugin/webuploader/css/style.css">
</head>
<body>
...
<script type="text/javascript" src="__ADMIN__/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="__STATIC__/plugin/webuploader/webuploader.min.js"></script>
<script type="text/javascript" src="__STATIC__/plugin/webuploader/upload.js"></script>
<script>
$(function(){
	var config = {
			"swf":"__STATIC__/plugin/webuploader/Uploader.swf",
			"server":"<?php echo $info['upload']; ?>",
			"filelistPah":"<?php echo $info['fileList']; ?>",
			"delPath":"<?php echo url('admin/Uploadify/delupload'); ?>",
			"chunked":false,
			"chunkSize":524288,
