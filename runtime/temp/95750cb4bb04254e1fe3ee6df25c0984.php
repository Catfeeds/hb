<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"../tpl/home/wap/seller\alliancebusiness.html";i:1519627752;s:27:"../tpl/home/wap/layout.html";i:1514211998;s:34:"../tpl/home/wap/public\header.html";i:1516333197;s:34:"../tpl/home/wap/public\footer.html";i:1514211999;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <?php endif; ?>
    ...
    <div class="lmsj">
        ...
        <p><?php echo (isset($msg) && ($msg !== '')?$msg:'您还未加入联盟商家'); ?></p>
        <a href="<?php echo url('Seller/contactinfo'); ?>"><span id="anniu"><?php if(!(empty($msg) || (($msg instanceof \think\Collection || $msg instanceof \think\Paginator ) && $msg->isEmpty()))): ?>已申请<?php else: ?>申请加入<?php endif; ?></span></a>
    </div>
