<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\useradvice\index.html";i:1514860789;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="builder-tabs builder-form-tabs">
                        ...
                        <ul class="nav nav-tabs">
                            <li <?php if($type != 'over'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('Useradvice/index'); ?>">待处理</a>
                            </li>
                            <li <?php if($type == 'over'): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo url('Useradvice/index',array('type'=>'over')); ?>">已处理</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <form class="form" method="get" action="">
                                        <div class="form-group right">
                                            <div class="input-group search-form">
                                                <input type="text" name="keyword" class="search-input form-control" value="<?php echo input('keyword'); ?>" placeholder="姓名/账号">
                                                    ...
                                                    <?php 
                                                     ...
                                                     if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a name="edit" title="查看详情" class="label label-primary-outline label-pill" href="<?php echo url('edit',array('id'=>$data['id'])); ?>">详情</a>

                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm"  href="<?php echo url('delete',array('id'=>$data['id'])); ?>">删除</a>
                                                            </td>
                                                        </tr>
