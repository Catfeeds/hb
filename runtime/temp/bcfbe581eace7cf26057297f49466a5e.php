<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/adminmall\view\goodmodel\edit.html";i:1514211965;s:80:"D:\UPUPW_ANK_W64\WebRoot\Vhosts\web\public/../shop/admin\view\public\layout.html";i:1515468228;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="model_name" value="<?php echo (isset($info['model_name']) && ($info['model_name'] !== '')?$info['model_name']:''); ?>" placeholder="模型名称" >
                                                </div>
                                            </div>
