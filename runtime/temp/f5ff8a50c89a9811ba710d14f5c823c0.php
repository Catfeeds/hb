<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"../tpl/home/wap/userorder\updatemobileself.html";i:1522652035;s:27:"../tpl/home/wap/layout.html";i:1514211998;s:34:"../tpl/home/wap/public\header.html";i:1516333197;s:34:"../tpl/home/wap/public\footer.html";i:1514211999;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <?php endif; ?>
    ...
    <div class="shezhi xgmm">
      <form class="postfrom" action="<?php echo url('updatemobileself'); ?>" >
        <ul>
            <li>原手机号： <span><input type="text" readonly="" value="<?php echo (\think\Session::get('user_login.mobile') ?: ''); ?>" class="sjh"><i id="yzm" settime="<?php echo (\think\Session::get('set_time') ?: ''); ?>" nowtime="<?php echo time(); ?>" class="sendmsg" onclick="sendMessage('<?php echo url('Common/sendCode'); ?>')" >获取验证码</i></span></li>
  ...
  <p class="xianshi">您正在进行手机号修改</p>
  <span id="anniu" class="button ajax-post" target-from="postfrom" >下一步</span>
